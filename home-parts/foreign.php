<div class="uk-margin-medium-top ">
    ...
    <div class="cat-title uk-flex uk-flex-between uk-flex-middle">
        <h1 class=" uk-heading-line uk-width-expand"><span><a href="/?cat=6" class="heading"><img
                ...
                class="author-side-img "> Foreign Affairs
 </a></span></h1>
        <a href="/?cat=126">
                        ...
                        <div>
                            <div class="uk-card uk-card-default">
                                ...
                                <div class="uk-card-body card-body">
                                    <h3 class="uk-card-title mukhya-img"><?php echo wp_trim_words(get_the_title(),10,'..');?></h3>
        ...
        <div class="uk-width-1-3@m uk-margin-small-top">
            <?php  get_template_part('home-parts/america'); ?>
        </div>
    </div>
    <div class="muni">
        <?php dynamic_sidebar('foreign-muni'); ?>
    </div>
</div>